...
PPCGroup PPCInstructions::Condition = {
	"mfcr", "mtcrf", "crand", "crandc",
	"creqv", "crnand", "crnor", "cror",
	"crorc", "crxor"
};
...
const char *PPCMetrics::decode(PPCInstruction instr) {
	...
	if (type == 4) {
		...
		else if (type == 33) return "crnor";
		else if (type == 50) return "rfi";
		else if (type == 129) return "crandc";
		else if (type == 150) return "isync";
		else if (type == 193) return "crxor";
		else if (type == 225) return "crnand";
		else if (type == 257) return "crand";
		else if (type == 289) return "creqv";
		else if (type == 417) return "crorc";
		else if (type == 449) return "cror";
		else if (type == 528) return "bcctr";
	}
	else if (type == 20) return "rlwimi";
	else if (type == 21) return "rlwinm";
	else if (type == 23) return "rlwnm";
