...
public:
	...
	void loadMem32(Register dest, Register base, uint32_t offset); // 3+ bytes
	void loadMem64(Register dest, Register base, uint32_t offset); // 4+ bytes
	
	void storeMem32(Register base, uint32_t offset, Register source); // 3+ bytes
	void storeMemImm32(Register base, uint32_t offset, uint32_t value); // 7+ bytes
	
	void lea64(Register reg, Register base, uint32_t offset); // 4+ bytes
	...
	void addMemReg32(Register base, uint32_t offset, Register other); // 3+ bytes
	void addMemImm32(Register base, uint32_t offset, uint32_t value); // 7+ bytes
	void addRegMem32(Register reg, Register base, uint32_t offset); // 3+ bytes
	...
	void decMem32(Register base, uint32_t offset); //3+ bytes
	...
	void andMemImm32(Register base, uint32_t offset, uint32_t value); // 7+ bytes
	
	void orReg32(Register reg, Register other); // 2 bytes
	void orImm32(Register reg, uint32_t value); // 6 bytes
	void orMemReg32(Register base, uint32_t offset, Register reg); // 3+ bytes
	void orMemImm32(Register base, uint32_t offset, uint32_t value); // 7+ bytes
	...
	void bitTestMem32(Register base, uint32_t offset, uint8_t bit); // 5+ bytes
	void bitTestReg32(Register reg, uint8_t bit); // 4 bytes
	
	void bitTestSetMem32(Register base, uint32_t offset, uint8_t bit); // 5+ bytes
	void bitTestResetMem32(Register base, uint32_t offset, uint8_t bit); // 5+ bytes
